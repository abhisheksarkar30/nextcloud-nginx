...
5. To remove default-phone-region warning, use: docker exec --user www-data nginx-nextcloud-1 php occ config:system:set default_phone_region --value=IN (INDIA)
